...
<section class="card"><h2>Install Configuration</h2><p><strong>PHP:</strong> <?= e(PHP_VERSION) ?></p><p><strong>Software Version:</strong> <?= e($settings['software_version'] ?? '0.1.0') ?></p><p><strong>Environment:</strong> <?= e((require dirname(__DIR__, 3) . '/app/config.php')['app']['env']) ?></p></section>
